...
class ProjectTests(TestCase):
    ...
    def test_same_tag_and_category_can_be_used_more_than_once(self):
        self.project2 = Project.objects.create(
            ...
            description="Beautiful website created for Oaks on Main Shopping Center in Knysna!",
            category=Category.objects.get(name="Website"),
        )

        self.project2.tags.add(Tag.objects.get(name="HTML5"))

        self.assertEqual(self.project.category, self.project2.category)
        self.assertEqual(list(self.project.tags.all()), list(self.project2.tags.all()))
